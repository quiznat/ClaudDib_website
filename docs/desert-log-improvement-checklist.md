...
- [ ] Pick the next website micro-surface after `postcards-next.html` so heartbeat refinement keeps rotating — target: `archive.html` or next retired/prototype surface that still carries mixed status signals (focus: continue reducing surface ambiguity)
