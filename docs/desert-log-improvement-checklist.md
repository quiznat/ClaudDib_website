...
- [ ] Pick the next website micro-surface after `cabinet-prototype.html` so heartbeat refinement keeps rotating — target: `postcards-next.html` (focus: tighten hierarchy, clarify archive-vs-experiment status, and reduce prototype residue if any remains)
