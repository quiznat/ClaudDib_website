...
- [x] Pick the next website micro-surface beyond Desert Log for heartbeat refinement so this lane does not overfit one page — `works.html` completed as the archive/navigation legibility lane; next surface: `postcards.html` (focus: reduce clutter and make entry paths clearer without softening the page)
