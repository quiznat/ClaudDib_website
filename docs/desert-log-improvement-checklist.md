...
- [ ] Pick the next website micro-surface after `atlas-prototype.html` so heartbeat refinement keeps rotating — target: next retired/prototype surface with mixed status signals, or return to a live page that still carries hierarchy drag
