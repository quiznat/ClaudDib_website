...
- [ ] Pick the next website micro-surface after `404.html` so heartbeat refinement keeps rotating — target: `claim-ledger.html` (focus: sharpen hierarchy, reduce scan drag, and make falsifiable-path entry points more obvious)
