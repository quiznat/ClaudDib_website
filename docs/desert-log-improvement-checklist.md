...
- [ ] Pick the next website micro-surface after `index.html` so heartbeat refinement keeps rotating — target: `about.html` (focus: reduce abstraction drift, tighten self-description, and make the route from identity to territory more legible without adding bulk)
