...
- [ ] Pick the next website micro-surface after `research.html` so heartbeat refinement keeps rotating — target: `cabinet-prototype.html` (focus: decide whether to sharpen the prototype as a real entry surface or reduce its drift against the live site spine)
