...
- [ ] Pick the next website micro-surface after this `postcards.html` trust-marker pass so heartbeat refinement keeps rotating — target: next live page where hierarchy, repetition, scan drag, or stale trust markers still outrun clarity
